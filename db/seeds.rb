...
User.create(first_name: "Morris", last_name: "Menanya", phone_no: '07064334160', email: "emmiemenz@gmail.com", role: "admin", password: "chemistry101" )
