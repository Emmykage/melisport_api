...
categories = ProductCategory.create([{name: "racquet", description: "For your first time on court to collecting titles on the pro tour, Babolat has a tennis racquet for every player. Babolat tennis racquets are designed to help you play your best and enjoy the game. We make tennis racquets for men, women, juniors & kids of all ages and abilities. Join millions of players around the world and check out the most popular Babolat tennis racquets like the spin producing Pure Aero, the power generating Pure Drive, or the control oriented Pure Strike. Not convinced? Ask Rafael Nadal, Dominic Thiem, Sofia Kenin, Li Na, and Kim Clijsters, or any other Babolat player."},
    ...
    men = Gender.find_by(name: "men")
    women = Gender.find_by(name: "women")
    racquet_category = ProductCategory.find_by(name: "racquet")
    shoe_category = ProductCategory.find_by(name: "shoe")
    professional = Level.find_by(stage: "professional")

    pure_aero = Product.create(name: "Pure Aero Unstrung", grip_size: "111", head_size: 645, level: professional,  rating: 5, length: "685", weight: "300", swing_weight: "290", stiffness: "69", composition: "graphite", price: 304000, image: "https://media.babolat.com/image/upload/f_auto,q_auto,c_pad,w_1008,h_1008/v1651570884/Product_Media/2023/TENNIS_RACKETS/EXPERT/101479-Pure_Aero-370-1-Face.png", product_category: racquet_category, description: "Do you want to dominate the game with ultimate spin? The 7th generation BABOLAT Pure Aero tennis racquet evolves with a unique approach engineered around the spin in your game. Join players like Rafael Nadal, Leylah Fernandez, Félix Auger-Aliassime, and Carlos Alcaraz and discover which Pure Aero racquet lets you own your spin. Have powerful strokes and want to dictate the points with controllable spin? You will love the BABOLAT Pure Aero.", gender: men)
