...
class PaymentShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_show" do
    assert_difference("PaymentShow.count") do
      post payment_shows_url, params: { payment_show: { amount: @payment_show.amount, provider: @payment_show.provider, status: @payment_show.status } }, as: :json
    end
  ...
  test "should update payment_show" do
    patch payment_show_url(@payment_show), params: { payment_show: { amount: @payment_show.amount, provider: @payment_show.provider, status: @payment_show.status } }, as: :json
    assert_response :success
  end
