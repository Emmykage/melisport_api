...
class BillingAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create billing_address' do
    assert_difference('BillingAddress.count') do
      post billing_addresses_url,
           params: { billing_address: { city: @billing_address.city, email: @billing_address.email, name: @billing_address.name,
                                        order_detail_id: @billing_address.order_detail_id, phone_no: @billing_address.phone_no, postal_code: @billing_address.postal_code, street: @billing_address.street } }
    end
  ...
  test 'should update billing_address' do
    patch billing_address_url(@billing_address),
          params: { billing_address: { city: @billing_address.city, email: @billing_address.email, name: @billing_address.name,
                                       order_detail_id: @billing_address.order_detail_id, phone_no: @billing_address.phone_no, postal_code: @billing_address.postal_code, street: @billing_address.street } }
