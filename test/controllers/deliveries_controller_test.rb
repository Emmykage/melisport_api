...
class DeliveriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery" do
    assert_difference("Delivery.count") do
      post deliveries_url, params: { delivery: { delivery_fee: @delivery.delivery_fee, state: @delivery.state } }
    end
  ...
  test "should update delivery" do
    patch delivery_url(@delivery), params: { delivery: { delivery_fee: @delivery.delivery_fee, state: @delivery.state } }
