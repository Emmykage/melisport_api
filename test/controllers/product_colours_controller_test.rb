...
class ProductColoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_colour" do
    assert_difference("ProductColour.count") do
      post product_colours_url, params: { product_colour: { colour: @product_colour.colour, product_id: @product_colour.product_id, quantity: @product_colour.quantity } }
    end
  ...
  test "should update product_colour" do
    patch product_colour_url(@product_colour), params: { product_colour: { colour: @product_colour.colour, product_id: @product_colour.product_id, quantity: @product_colour.quantity } }
